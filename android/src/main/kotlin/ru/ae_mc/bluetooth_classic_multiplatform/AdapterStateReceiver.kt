...
class AdapterStateReceiver : EventChannel.StreamHandler {
    companion object {
        const val CHANNEL_NAME: String = "${Helper.NAMESPACE}/adapterState"
    }
    ...
    val mBluetoothAdapterStateReceiver: BroadcastReceiver =
            object : BroadcastReceiver() {
                override fun onReceive(context: Context, intent: Intent) {
                    ...
                    adapterStateEventSink.let {
                        it?.success(Helper.adapterStateString(adapterState))
                    }
                }
            }
}
