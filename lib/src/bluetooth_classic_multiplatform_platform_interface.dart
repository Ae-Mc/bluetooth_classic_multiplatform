...
abstract class BluetoothClassicMultiplatformPlatformInterface
    extends PlatformInterface {
  /// Constructs a BlueClassicPlatform.
  BluetoothClassicMultiplatformPlatformInterface() : super(token: _token);

  static final Object _token = Object();

  static BluetoothClassicMultiplatformPlatformInterface _instance =
      BluetoothClassicMultiplatformMethodChannel();

  /// The default instance of [BlueClassicPlatform] to use.
  ///
  /// Defaults to [MethodChannelBlueClassic].
  static BluetoothClassicMultiplatformPlatformInterface get instance =>
      _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [BlueClassicPlatform] when
  /// they register themselves.
  static set instance(BluetoothClassicMultiplatformPlatformInterface instance) {
