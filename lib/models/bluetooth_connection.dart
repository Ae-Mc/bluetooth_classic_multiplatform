...
class BluetoothConnection {
  ...
  BluetoothConnection._consumeConnectionID(this.id)
    : _readChannel = EventChannel(
        '${BluetoothClassicMultiplatformInterface.namespace}/read/$id',
      ) {
    ...
    output = BluetoothStreamSink(id);
  }

  /// Returns connection to given address.
  static Future<BluetoothConnection> toAddress(
    String? address, {
  ...
  static Future<BluetoothConnection> toAddressBLE(String? address) async {
    ...
    return BluetoothConnection._consumeConnectionID(
      await MethodChannelBluetoothClassicMultiplatform.methodChannel
